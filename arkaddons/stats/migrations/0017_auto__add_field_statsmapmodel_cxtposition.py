...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StatsMapModel.cxtposition'
        db.add_column(u'stats_statsmapmodel', 'cxtposition',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StatsMapModel.cxtposition'
        db.delete_column(u'stats_statsmapmodel', 'cxtposition')
    ...
    models = {
        ...
        u'stats.statsmapmodel': {
            ...
            'cxtposition': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
