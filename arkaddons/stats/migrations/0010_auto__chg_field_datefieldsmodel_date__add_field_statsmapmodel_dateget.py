...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DateFieldsModel.date'
        db.alter_column(u'stats_datefieldsmodel', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding field 'StatsMapModel.dateget'
        db.add_column(u'stats_statsmapmodel', 'dateget',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DateFieldsModel.date'
        db.alter_column(u'stats_datefieldsmodel', 'date', self.gf('django.db.models.fields.DateTimeField')(max_length=100, null=True))
        # Deleting field 'StatsMapModel.dateget'
        db.delete_column(u'stats_statsmapmodel', 'dateget')
