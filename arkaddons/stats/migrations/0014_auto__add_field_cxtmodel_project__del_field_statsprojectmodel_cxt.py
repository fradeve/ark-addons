...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CxtModel.project'
        db.add_column(u'stats_cxtmodel', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stats.StatsProjectModel'], null=True),
                      keep_default=False)

        # Deleting field 'StatsProjectModel.cxt'
        db.delete_column(u'stats_statsprojectmodel', 'cxt_id')


    def backwards(self, orm):
        # Deleting field 'CxtModel.project'
        db.delete_column(u'stats_cxtmodel', 'project_id')

        # Adding field 'StatsProjectModel.cxt'
        db.add_column(u'stats_statsprojectmodel', 'cxt',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stats.CxtModel'], null=True, blank=True),
                      keep_default=False)
