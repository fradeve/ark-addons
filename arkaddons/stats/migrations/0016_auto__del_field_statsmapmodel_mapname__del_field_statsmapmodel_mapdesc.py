...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StatsMapModel.mapname'
        db.delete_column(u'stats_statsmapmodel', 'mapname')

        # Deleting field 'StatsMapModel.mapdesc'
        db.delete_column(u'stats_statsmapmodel', 'mapdesc')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'StatsMapModel.mapname'
        raise RuntimeError("Cannot reverse this migration. 'StatsMapModel.mapname' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'StatsMapModel.mapname'
        db.add_column(u'stats_statsmapmodel', 'mapname',
                      self.gf('django.db.models.fields.CharField')(max_length=15),
                      keep_default=False)

        # Adding field 'StatsMapModel.mapdesc'
        db.add_column(u'stats_statsmapmodel', 'mapdesc',
    ...
    models = {
        u'stats.apifieldsmodel': {
            ...
            'cxt': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['stats.CxtModel']", 'null': 'True', 'blank': 'True'}),
