...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApiFieldsModel.cxt'
        db.add_column(u'stats_apifieldsmodel', 'cxt',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stats.CxtModel'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'stats_apifieldsmodel', 'cxt_id')
