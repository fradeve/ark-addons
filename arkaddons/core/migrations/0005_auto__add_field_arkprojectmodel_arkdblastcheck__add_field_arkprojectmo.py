...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArkProjectModel.projectname'
        db.alter_column(u'core_arkprojectmodel', 'projectname', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ArkProjectModel.projectname'
        db.alter_column(u'core_arkprojectmodel', 'projectname', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
    ...
    models = {
        u'core.arkprojectmodel': {
            ...
            'arkdblastcheck': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'arkdbstatus': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
